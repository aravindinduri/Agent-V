...
class ClaimRouter:
    ...
    def route(self, data: ExtractedData) -> AgentOutput:
        ...
        elif data.asset_details.estimated_damage and data.asset_details.estimated_damage < 25000:
            route = "Fast-track"
            reasoning = f"Estimated damage (${data.asset_details.estimated_damage}) is under the $25,000 threshold."
